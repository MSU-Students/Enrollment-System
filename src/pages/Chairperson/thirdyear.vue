...
@Options({
  ...
  methods: {
    ...mapActions('ThirdYear1stSem', [
      'addThirdYear1stSem',
      'editThirdYear1stSem',
      'deleteThirdYear1stSem',
    ]),
    ...mapActions('ThirdYear2ndSem', [
      'addThirdYear2ndSem',
      'editThirdYear2ndSem',
      'deleteThirdYear2ndSem',
    ]),
  },
})
  ...
  columns = [
    {
      ...
      label: 'Subjects',
      align: 'left',
      field: (row: IThirdYear1stSemInfo) => row.subject + ' ',
  ...
  columns2 = [
    {
      ...
      label: 'Subjects',
      align: 'left',
      field: (row: IThirdYear2ndSemInfo) => row.subject,
      format: (val: string) => `${val}`,
    },
    {
      name: 'Description',
