<template>
  <q-page class="q-pa-lg">
    <div>
      <div class="text-h4 text-white text-bold flex flex-center">FIRST YEAR SUBJECTS</div>
        <br />
...
@Options({
  ...
  methods: {
    ...mapActions('FirstYear1stSem', ['addFirstYear', 'editFirstYear', 'deleteFirstYear']),
    ...mapActions('FirstYear2ndSem', ['addFirstYear2ndSem', 'editFirstYear2ndSem', 'deleteFirstYear2ndSem']),
  ...
  columns2 = [
    {
      ...
      label: 'Subject',
      align: 'left',
      field: (row: IFirstYear2ndSemInfo) =>
        row.subjectSecond + ' ',
      format: (val: string) => `${val}`,
    },
     {
