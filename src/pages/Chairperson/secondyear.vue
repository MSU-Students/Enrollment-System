...
@Options({
  ...
  methods: {
    ...mapActions('SecondYear1stSem', [
      'addSecondYear1stSem',
      'editSecondYear1stSem',
      'deleteSecondYear1stSem',
    ]),
    ...mapActions('SecondYear2ndSem', [
      'addSecondYear2ndSem',
      'editSecondYear2ndSem',
      'deleteSecondYear2ndSem',
    ]),
  },
})
  ...
  columns = [
    {
      ...
      label: 'Subjects',
      align: 'left',
      field: (row: ISecondYear1stSemInfo) => row.subject + ' ',
  ...
  columns2 = [
    {
      ...
      label: 'Subjects',
      align: 'left',
      field: (row: ISecondYear2ndSemInfo) => row.subject,
      format: (val: string) => `${val}`,
    },
    {
      name: 'Description',
